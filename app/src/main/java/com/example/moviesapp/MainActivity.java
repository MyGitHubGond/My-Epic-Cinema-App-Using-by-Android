        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userEdt.getText().toString().isEmpty() || passEdt.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "Please fill in your username and password", Toast.LENGTH_LONG).show();
                    ...
                    Intent intent = new Intent(MainActivity.this, IntroActivity.class);  // Replace MainActivity with your target activity
                    startActivity(intent);
                } else {
                    // Show a toast message if username or password is incorrect
                    Toast.makeText(MainActivity.this, "Your username and password are not correct", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
